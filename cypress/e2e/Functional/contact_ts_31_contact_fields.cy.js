...
TC_65: Verify contact us form holds necessary fields in it
*/
...
describe("Verification of Contact Page TS 31 Contact Us Form", () => {
  viewports.forEach(({ device, viewport }) => {
    it(`Verify contact us form holds necessary fields in it on ${device}`, () => {
      // Set the viewport for each test case
      cy.viewport(viewport);
      contactPage.verifyContactFormFields(device);
    });
  });
});
